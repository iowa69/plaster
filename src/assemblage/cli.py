...
``assemblage view`` opens the interactive studio; the other subcommands run the
...
from .core.errors import AssemblageError
...
/_/   \_\___/___/\___|_| |_| |_|_.__/|_|\__,_|\__, |\___|
                                              |___/
 assembly graph studio -- visualise, evaluate, scaffold
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "examples:\n"
            "  assemblage view assembly.gfa\n"
            "  assemblage view assembly.gfa -r reference.fasta\n"
            "  assemblage qc assembly.gfa -r reference.fasta --html report.html\n"
            "  assemblage scaffold assembly.gfa -r reference.fasta -o out/ --break-misassemblies\n"
    ...
    parser.add_argument("--version", action="version", version=f"assemblage {__version__}")
    ...
    _add_common(p_sc)
    _add_reference(p_sc)
    p_sc.add_argument("-o", "--outdir", default="assemblage_out")
    ...
    _add_common(p_ex)
    _add_reference(p_ex)
    p_ex.add_argument("-o", "--outdir", default="assemblage_out")
    p_ex.add_argument(
        "--export",
        nargs="+",
