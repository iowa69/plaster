"""Typed errors used across Assemblage.
...
class AssemblageError(Exception):
    """Base class for every error Assemblage raises deliberately."""


class AssemblageFormatError(AssemblageError):
...
class MissingDependencyError(AssemblageError):
...
class GraphOperationError(AssemblageError):
