...
def _template_dir() -> str:
    """Locate ``assemblage/templates`` whether installed or run from source."""
    try:
        from importlib import resources

        path = resources.files("assemblage").joinpath("templates")
